import type { AssetClass, AlertSeverity } from './types.ts';
...
export const mockPolicies: Policy[] = [
  ...
  // ==========================================================================
  {
    ...
    description:
      'Declaração formal de política de investimentos (IPS) acordada bilateralmente com o titular Miguel. Define regras e limites contratuais intransponíveis para a gestão discricionária de seu patrimônio.',
    ruleSource: 'MANDATO_CLIENTE',
    ...
    rules: mockPolicyRules.filter((r) => r.policyId === 'IPS-AW-001'),
    clientName: 'Miguel',
    ownerDepartment: 'MPX Wealth Management',
    reviewFrequency: 'SEMESTRAL',
    lastReviewedAt: '28/12/2025',
    nextReviewDate: '30/06/2026',
    fiduciaryDistinctionSummary:
      'MANDATO DO CLIENTE (IPS CONTRATUAL): Compromisso bilateral direto com o investidor Miguel. O descumprimento dos limites de piso (40% RF) ou teto (35% RV) gera risco fiduciário contratual direto perante o titular. Exige rebalanceamento compulsório tempestivo ou assinatura de aditivo bilateral pelo cliente.',
  },
...
export const mockPolicyAssignments: PolicyAssignment[] = [
  // Carteira port-dario-001 (Dário Marques Neto) vinculada ao seu Mandato IPS e políticas internas
  {
    id: 'asg-dario-ips',
    policyId: 'IPS-DARIO-001',
    policyCode: 'IPS-DARIO-001',
    policyName: 'Mandato Bilateral Carteira Dário',
    policyVersionId: 'ver-ips-dario-001-v1.0',
    ...
    status: 'ACTIVE',
    assignedAt: '15/01/2026 09:00:00',
    assignedBy: 'MPX Wealth Management',
    effectiveDate: '15/01/2026',
    clientConsentStatus: 'ASSINADO',
    complianceNotes: 'Mandato fiduciário individual Dário Marques Neto (Itaú Private + Avenue Offshore).',
  },
  {
    id: 'asg-dario-pol-int-conc',
    policyId: 'POL-INT-CONCENTRACAO',
    ...
    status: 'ACTIVE',
    assignedAt: '15/01/2026 09:30:00',
    assignedBy: 'MPX Wealth Management',
    effectiveDate: '15/01/2026',
    clientConsentStatus: 'DISPENSADO',
    complianceNotes: 'Política interna de governança MPX Wealth Management.',
  },

  // Carteira port-miguel-001 (Miguel) vinculada ao seu Mandato IPS e às políticas internas
  {
    id: 'asg-001-ips-aw',
    policyId: 'IPS-AW-001',
    ...
    effectiveDate: '01/01/2026',
    clientConsentStatus: 'ASSINADO',
    complianceNotes: 'Mandato fiduciário independente do cliente Miguel.',
  },
  {
  ...
  // Carteira port-wilson-001 (Wilson) vinculada ao seu Mandato IPS
  {
    id: 'asg-wilson-ips',
    policyId: 'IPS-WILSON-001',
    policyCode: 'IPS-WILSON-001',
    policyName: 'Mandato Bilateral Carteira Wilson',
    policyVersionId: 'ver-ips-wilson-001-v1.0',
    policyVersionNumber: 'v1.0',
    ...
    isPrimaryMandate: true,
    status: 'ACTIVE',
    assignedAt: '10/01/2026 09:00:00',
    assignedBy: 'MPX Wealth Management',
    effectiveDate: '10/01/2026',
    clientConsentStatus: 'ASSINADO',
    complianceNotes: 'Mandato fiduciário independente do cliente Wilson.',
  },
